/**********************************************************************************************************************
 * \file Lcf_Tasking_BankB.lsl
 * \brief Linker command file for Tasking compiler - BANK B (0xA0200000)
 * \copyright Copyright (C) Infineon Technologies AG 2019
 * 
 * DUAL BANK CONFIGURATION - BANK B
 * This configuration places code at Bank B (0xA0200000 - 0xA03FFFFF, 2MB)
 * Used for OTA updates with failover capability
 * 
...
#define LCF_INTVEC0_START 0x804FE000    /* Bank B: Offset +0x200000 */
#define LCF_INTVEC1_START 0x807FC000    /* Bank B: Offset +0x200000 */
#define LCF_INTVEC2_START 0x807FE000    /* Bank B: Offset +0x200000 */

#define LCF_TRAPVEC0_START 0x80200100   /* Bank B: Offset +0x200000 */
#define LCF_TRAPVEC1_START 0x80500000   /* Bank B: Offset +0x200000 */
#define LCF_TRAPVEC2_START 0x80500100   /* Bank B: Offset +0x200000 */

#define LCF_STARTPTR_CPU0 0x80200000    /* Bank B Cached: Offset +0x200000 */
#define LCF_STARTPTR_CPU1 0x80500200    /* Bank B Cached: Offset +0x200000 */
#define LCF_STARTPTR_CPU2 0x80500220    /* Bank B Cached: Offset +0x200000 */

#define LCF_STARTPTR_NC_CPU0 0xA0200000    /* Bank B Start Address */
#define LCF_STARTPTR_NC_CPU1 0xA0500200
#define LCF_STARTPTR_NC_CPU2 0xA0500220
...
derivative tc37
{
    ...
    {
        mau = 8;
        size = 2M;    // Bank B: 2MB (0xA0200000 - 0xA03FFFFF)
        type = rom;
